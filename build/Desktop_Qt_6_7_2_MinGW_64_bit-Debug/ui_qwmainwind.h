...
public:
    ...
    void setupUi(QMainWindow *QWMainWind)
    {
        ...
        acttool = new QAction(QWMainWind);
        acttool->setObjectName("acttool");
        acttool->setIcon(icon3);
    ...
    void retranslateUi(QMainWindow *QWMainWind)
    {
        ...
        acttool->setText(QCoreApplication::translate("QWMainWind", "\344\277\241\346\201\257", nullptr));
#if QT_CONFIG(tooltip)
        acttool->setToolTip(QCoreApplication::translate("QWMainWind", "\346\230\276\347\244\272\345\274\200\345\217\221\350\200\205\344\277\241\346\201\257", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(shortcut)
        acttool->setShortcut(QCoreApplication::translate("QWMainWind", "Ctrl+X", nullptr));
#endif // QT_CONFIG(shortcut)
